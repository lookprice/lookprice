...
export const SettingsIntegrationsTab = ({ lang }: SettingsIntegrationsTabProps) => {
  ...
  return (
    ...
    >
      <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-2xl p-6 md:p-8 rounded-2xl md:rounded-3xl border border-slate-200/80 dark:border-slate-800/80 shadow-xs relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-8 relative">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-white tracking-tight leading-tight">{t('Google Drive Yedekleme Sistemi', 'Google Drive Backup System', 'Σύστημα Δημιουργίας Αντιγράφων Google Drive')}</h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mt-0.5">{t('Bulut sürücünüzü bağlayıp verilerinizi otomatik/manuel yedekleyin.', 'Connect your cloud drive to backup data automatically/manually.', 'Συνδέστε το cloud drive σας για αυτόματη/χειροκίνητη δημιουργία αντιγράφων.')}</p>
            </div>
          </div>
          <div className="flex items-center space-x-3">
