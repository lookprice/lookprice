              ...
              {loading ? (
                ...
                paginatedSales.map((s) => (
                  ...
                  >
                    ...
                    <td className="px-3.5 py-4">
                      {s.status === 'cancelled' ? (
                        <div className="max-w-[180px]" title={s.cancellation_reason || s.cancel_reason || s.notes || ''}>
                          <p className="text-[11px] font-bold text-rose-600 truncate bg-rose-50/80 px-2 py-1 rounded-lg border border-rose-100 inline-block">
