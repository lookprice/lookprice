...
import { ListingCardImage } from "../components/marketplace/ListingCardImage";
import { MarketplaceStoryReels } from "../components/marketplace/MarketplaceStoryReels";
  ...
  return (
    <div className={`min-h-screen w-full max-w-full overflow-x-hidden font-sans transition-colors duration-300 ${bgCanvas}`}>
      ...
      <ListingDetailModal
        ...
        activeDetailImageIndex={activeDetailImageIndex}
        setActiveDetailImageIndex={setActiveDetailImageIndex}
        formatCategory={formatCategory}
        formatLocation={formatLocation}
        getSquareMeters={getSquareMeters}
        formatTitleDeedType={formatTitleDeedType}
