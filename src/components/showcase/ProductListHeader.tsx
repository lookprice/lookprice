...
export const ProductListHeader: React.FC<ProductListHeaderProps> = ({
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-12">
      <div>
        <h2
          className={`text-3xl md:text-4xl text-slate-900 tracking-tight ${isLuxury ? "!font-sans !font-bold" : "font-semibold font-display tracking-tighter"}`}
        >
      ...
      <div className="flex items-center gap-4 w-full md:w-auto">
        <div className="relative group w-full md:w-auto">
          ...
          <select
            ...
            className="appearance-none pl-11 pr-12 py-3 bg-white border border-gray-100 rounded-2xl text-sm font-bold text-gray-700 outline-none cursor-pointer hover:bg-gray-50 transition-all shadow-sm w-full md:min-w-[200px]"
          >
