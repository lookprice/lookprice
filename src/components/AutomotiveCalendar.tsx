...
export const AutomotiveCalendar = ({ storeId, vehicles, onClose }: AutomotiveCalendarProps) => {
    ...
    <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-xl overflow-hidden flex flex-col h-[85vh] max-h-[900px]">
      <div className="p-6 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-50/50">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-black text-slate-900 tracking-tight">Randevu Takvimi</h2>
          ...
          <div className="sticky top-0 bg-transparent space-y-6">
            <div>
              ...
              <p className="text-xs text-slate-500 font-bold">
                {selectedDayTasks.length} Planlanmış Randevu
              </p>
            </div>
              ...
              <AnimatePresence mode="popLayout">
                {selectedDayTasks.length === 0 ? (
                  ...
                  >
                    ...
                    <p className="text-xs font-bold text-slate-400">Bu tarih için planlanmış<br/>randevu bulunmuyor.</p>
                  </motion.div>
                ) : (
                    ...
                    return (
                      ...
                      >
                        ...
                        <h4 className="text-sm font-black text-slate-900 mb-2 group-hover:text-indigo-600 transition-colors">
                          {vehicle ? `${vehicle.brand} ${vehicle.model}` : 'Randevu'}
                        </h4>
                        ...
                        <div className="space-y-2 mb-4">
                          ...
                          <div className="flex items-center gap-2 text-xs text-slate-500 font-bold">
                            ...
                            <span className="truncate">{vehicle?.plate || 'Plaka Bilgisi Yok'}</span>
                          </div>
                        </div>
