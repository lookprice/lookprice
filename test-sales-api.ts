...
async function run() {
  try {
    const userRes = await pool.query("SELECT * FROM users WHERE email = 'lookprice.me@gmail.com'");
    ...
    // Simulate API call locally over HTTP... But it's easier to just fetch from the dev server running on 3000
