  ...
  const payloads = [
    {
      ...
      deliveryAccount: acct, despatchAdviceAccount: acct, buyerAccount: acct, sellerAccount: acct,
      despatchAdviceDetail: [ { qty: 1, quantity: 1, deliveredQuantity: 1, productName: "Test", unitCode: "C62", id: "1" } ],
      shipment: { driverName: "a", driverSurname: "b", driverVknTckn: "11111111111", plateNumber: "34AAA", actualDeliveryDate: "2024-05-01", actualDeliveryTime: "12:00:00" },
