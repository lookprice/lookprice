...
async function run() {
  ...
  const payload = {
      ...
      despatchDetail: [ { 
          id: "1", lineIndex: 1, stockCode: "A", stockName: "A", name: "A", productName: "A", 
          quantity: 1, deliveredQuantity: 1, qty: 1, unitCode: "C62", 
          price: 0, unitPriceTra: "0", amtTra: "0" 
      } ],
      shipment: { 
          driverName: "a", driverSurname: "b", driverVknTckn: "11111111111", 
          plateNumber: "34AAA", actualDeliveryDate: "2024-05-01", actualDeliveryTime: "12:00:00" 
      },
