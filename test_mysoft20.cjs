...
async function run() {
  ...
  const payload = {
      ...
      despatchAdviceDetail: [ { id: "1", productName: "A", quantity: 1, unitCode: "C62" } ],
      invoiceDetail: [ { id: "1", productName: "A", quantity: 1, unitCode: "C62" } ],
      ...
      currencyCode: "TRY", currencyRate: "1",
      notes: [], noteList: [], note: ""
  };
